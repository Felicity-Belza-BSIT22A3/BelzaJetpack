package com.example.belzajetpack
    ...
    Box (
        ...
        Card( //q1
            colors = CardDefaults.cardColors(
                containerColor = Color(239, 188, 155),
        ...
        Card( //q2
            colors = CardDefaults.cardColors(
                containerColor = Color(251, 243, 213),
        ...
        Card( //q3
            colors = CardDefaults.cardColors(
                containerColor = Color(214, 218, 200),
        ...
        Card( //q4
            colors = CardDefaults.cardColors(
                containerColor = Color(156, 175, 170),
            ),
            shape = RectangleShape,
            modifier = Modifier
                .fillMaxWidth(0.5f)
